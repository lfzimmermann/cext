...
# --- Distribution Files ---
# An explicit list of all files to be included in the distribution tarball.
# This is more robust than using wildcards for distribution.
DIST_FILES = \
	Makefile \
	README.md \
	main.c \
	include/editor_api.h \
	src/backend/gap_buffer.c \
	src/backend/gap_buffer.h \
	src/backend/text_logic.c \
	src/backend/text_logic.h \
	src/frontend/terminal_ui.c \
	src/frontend/terminal_ui.h
...
.PHONY: all clean run check dist distcheck
...
# =============================================================================
# Testing and Distribution Rules
# =============================================================================

# Rule to run tests.
# This currently has a placeholder command.
check: $(TARGET)
