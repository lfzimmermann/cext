...
OBJS_MAIN = $(addprefix $(BUILD_DIR)/, $(notdir $(SRC_MAIN:.c=.o)))
...
$(TARGET_CLI): $(OBJS_MAIN) $(OBJS_BACKEND)
...
$(TARGET_GUI): $(OBJS_MAIN) $(OBJS_FRONTEND) $(OBJS_BACKEND)
